...
- **🧩 Sillabe** — esercizio di lettura sillabica ispirato ai fogli usati a scuola: 5 gruppi di lettere per ora (B, C, F, M, S), ciascuno con le sue 5 sillabe (BA/BE/BI/BO/BU...) da **trascinare** con il dito sullo spazio vuoto della parola giusta, scelta guardando il disegno (es. BA + NANA = banana 🍌). Trascinamento vero, nessuna penalità sul tentativo sbagliato: la sillaba torna semplicemente al suo posto e si può riprovare.
